...
export const experiences = {
  ...
  faqList: [
    {
      question: `2025 Health New Zealand Te Whatu Ora - Intern`,
      answer: `Optimized automated reporting workflows using Power BI and Excel, integrating SharePoint, SQL, and internal data sources to improve data reliability and reduce manual processing across regional teams. Designed scheduled refresh pipelines and parameterized dashboards to deliver scalable, accurate operational insights for multiple stakeholders. Standardized 20+ fragmented datasets into a unified reporting framework, improving efficiency and earning a top-rated internship evaluation.`,
      category: "General",
    ...
    // },
    {
      question: `2018-2021 Harcourts - Data Analyst`,
      answer: `Managing 50–70 property listings per month across multiple platforms and analysing sales, lead, and market performance data. Built interactive Excel and Power BI dashboards to track KPIs, agent performance, and campaign ROI, improving lead engagement by 15%. Delivered data-driven insights to sales and marketing teams, optimizing pricing strategies, resource allocation, and time-to-sale.`,
      category: "General",
    ...
    },
    {
      ...
      answer: {
        content:
          "It includes the Figma UI kit, React Material UI codebase, regular updates, and customer support.",
        type: "list",
        data: [
    ...
    },
    {
      ...
      answer: {
        ...
        type: "list",
        data: [
          { primary: `1 Year Free Updates` },
          { primary: `License validity is lifetime` },
        ],
      },
    ...
    },
    {
      ...
      answer: {
        ...
        type: "list",
        data: [
          { primary: `6 Months Support` },
          { primary: `No Installation Support` },
          { primary: `No Customization Support` },
        ],
      },
      category: "Support & Updates",
    },
