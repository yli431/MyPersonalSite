...
export default function FollowME({ heading = true, color }) {
  return (
...
FollowME.propTypes = { heading: PropTypes.oneOfType([PropTypes.bool, PropTypes.string]), color: PropTypes.string };
